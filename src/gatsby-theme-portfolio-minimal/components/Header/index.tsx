...
export function Header(): React.ReactElement {
    ...
    const { dispatch, globalState } = useGlobalState();
    ...
    const themeToggler = (
        ...
        >
            <img
                src={globalState.theme === Theme.Light ? moon : sun}
                alt="fireSpot"
            />
        </button>
    );
        ...
        <>
            ...
            siteConfiguration.navigation.ctaButton?.label ? (
                <Link
                    ...
                    onClick={
                        !isDesktopBreakpoint ? () => setOpen(!open) : undefined
                    }
                >
                    {siteConfiguration.navigation.ctaButton.label}
                </Link>
    ...
    return (
        <header className={classes.Header}>
            ...
            <Animation className={classes.ContentWrapper} type="fadeDown">
                ...
                {isDesktopBreakpoint ? null : themeToggler}
